...
public class Uploader extends Thread {
	...
	public Uploader(Handler handler, String serverUploadURL) {
	...
	private void upLoad() throws UploadException {
		PostMethod filePost = new PostMethod(serverUploadURL);
		PostMethod fileGet = new PostMethod(serverUploadURL);
		try {
