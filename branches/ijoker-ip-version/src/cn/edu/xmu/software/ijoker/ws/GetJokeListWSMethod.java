...
public class GetJokeListWSMethod extends AbstractWSMethod {
	...
	public void invokeWSMethod() throws CallWebServiceException {
		...
		if (result != null && result.getPropertyCount() > 0) {
			...
			String mediaBaseURL = (String) parms.get(Consts.MEDIA_URL);
			parms.remove(Consts.MEDIA_URL);
			...
			while (iterator.hasNext()) {
				...
				joke
						.setLike(Integer.parseInt(o.getProperty("like")
								.toString()));
				joke.setId(o.getProperty("id").toString());
				joke.setLocation(mediaBaseURL + o.getProperty("location"));
