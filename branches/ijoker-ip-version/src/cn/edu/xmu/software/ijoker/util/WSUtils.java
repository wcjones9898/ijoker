...
public class WSUtils {
	...
	public static Object callWebService(String methodName,
		...
		String serverBaseURL = (String) params.get(Consts.SERVER_URL);
		params.remove(Consts.SERVER_URL);
		String wsdl = serverBaseURL + methodName + "?wsdl";
		String nameSpace = serverBaseURL + methodName;
		Log.i(TAG, "wsdl: " + wsdl + "\n namespace: " + nameSpace
