...
public class Functions extends Activity {
	...
	private String funcNames[] = { "听笑话", "讲笑话", "关于'笑客'" };
	private int funcImages[] = { R.drawable.icon_laugh, R.drawable.icon_free,
			R.drawable.icon_vip };
	private int funcIndex;
	private int funcNum;
	private TextView funcs_text;
	private ImageButton funcs_img;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ImageButton leftfunc_btn = (ImageButton) findViewById(R.id.LeftFunc_button);
		ImageButton rightfunc_btn = (ImageButton) findViewById(R.id.RightFunc_button);
