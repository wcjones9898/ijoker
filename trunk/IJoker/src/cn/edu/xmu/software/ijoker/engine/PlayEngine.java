...
public class PlayEngine {
	...
	public PlayEngine(Context context, ImageButton playButton,
	...
	public void downloadAudioIncrement(String mediaUrl) throws IOException {
		...
		Log.i("downloadingMediaFile path:", downloadingMediaFile.getPath());
	...
	private void startMediaPlayer() {
		try {
			File bufferedFile = File.createTempFile("bufferedFile", ".dat",
					Environment.getExternalStorageDirectory());
			Log.i("bufferedFile path:", bufferedFile.getPath());
	...
	private void transferBufferToMediaPlayer() {
		try {
			...
			File oldBufferedFile = File.createTempFile("oldBufferedFile",
					".dat", Environment.getExternalStorageDirectory());
			Log.i("oldBufferedFile path:", oldBufferedFile.getPath());
			File bufferedFile = File.createTempFile("bufferedFile", ".dat",
					Environment.getExternalStorageDirectory());
			Log.i("bufferedFile path:", bufferedFile.getPath());
